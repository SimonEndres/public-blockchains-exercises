...
const contractName3 = "Lock3";
const contractAddress3 = "0x5FbDB2315678afecb367f032d93F642f64180aa3";
...
async function constructor() {
    ...
    const hardhatSigner = await hre.ethers.getSigners();
    const hhSigner = hardhatSigner[0];
    const lock = await hre.ethers.getContractAt(contractName3, contractAddress3, hhSigner)

    console.log("Deployed Block Number: " + await lock.deployedBlockNumber());
