...
// Your code here!
console.log('hre-version: ' + hre.version);
...
async function main() {
  ...
  console.log('signer address: ' + hhSigner.address);
  ...
  const contractLock2 = await hre.ethers.getContractAt(contractName, contractAddress, hhSigner);
  console.log('contract address: ' + contractLock2.address);
  ...
  const readContract = async (lockContract = contractLock2) => {
      
    // Print the owner of the lock.
   
    // Your code here!
    let owner = await contractLock2.owner();
    ...
    // Your code here!
    let unlockTime = await (Date)((Number)(contractLock2.unlockTime));
